...
up-to-date documentation for the respective tools, as well as to the latest 
...
In the Specific Grant Agreement (SGA) called *Harmonised protection
of CENSUS data in the ESS* two SDC methods have been developed and tested. In
...
During that SGA some initial SAS code was used to test the methods. 
For reference: the SAS code for the cell key method can be found 
...
were implemented in the open-source software R and Argus. 
These implementations can be downloaded on the respective 
